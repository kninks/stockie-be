...
class JobTypeEnum(str, Enum):
    ...
    PULL_PRICES = "Pull Closing Prices"


class JobConfigEnum(str, Enum):
    PULL_PRICES_CIRCUIT_BREAKER = "PULL_PRICES_CIRCUIT_BREAKER"
    ...
    CLEANUP_CLOSING_PRICES_DAYS_BACK = "CLEANUP_CLOSING_PRICES_DAYS_BACK"
    ...
    LAST_SUCCESS_PULL_PRICES = "LAST_SUCCESS_PULL_PRICES"
